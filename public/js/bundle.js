    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status.toLowerCase() === 'success') location.reload(true);
            _context2.next = 10;
            break;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFmMmNvbSIsImEiOiJjazFrcjAweTAxMG54M2twZzJtamYyZ2w4In0.pFQ7CtYOjlocHanmXXFajQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/haf2com/ck1kr6f120aew1cmkni35i5kl',
    scrollZoom: false //center: [34.111745, -89.113491],
    //zoom: 10,
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_LufmhvPFMvNt6LTFyvoBOz2r00sg64QpZL'); // 1) Get checkout session from API
...
if (mapBox) {
  ...
  if (locations.length > 0) (0, _mapbox.displayMap)(locations);
}
